//callback
let postingan = [
    {title:'First Post', desc:'Ini adalah post pertama'},
    {title:'Second Post', desc:'Ini adalah post pertama'}
]
...
buatPos({title:'Third Post', desc:'AAAAAAAAAAAAAAaa'}, cekPos)
...
sendDataUsingPromise('https://sentiment-analisis-api.herokuapp.com/sentiment').then(data=>data.json()).then(data=>console.log(data)).catch(e=>console.log(e))
